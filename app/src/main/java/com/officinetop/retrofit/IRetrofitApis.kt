...
interface IRetrofitApis {
    ...
    @GET(Constant.UrlEndPoints.alloy_rim_attachments_by_type_diameter)
    fun rimavailablesublist(@Query("diameter_rear_id") diameter_rear_id: String,
                   @Query("car_type_id") car_type_id: String,
                   @Query("diameter_front_id") diameter_front_id: String
