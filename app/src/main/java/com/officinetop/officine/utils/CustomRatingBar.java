...
public class CustomRatingBar extends View {
    ...
    private CustomRatingBar.Gravity gravity;
    ...
    private CustomRatingBar.OnRatingBarChangeListener ratingListener;
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        gravity = CustomRatingBar.Gravity.fromId(arr.getInt(R.styleable.SimpleRatingBar_srb_gravity, CustomRatingBar.Gravity.Left.id));
    ...
    private void drawFromLeftToRight(Canvas internalCanvas) {
        ...
        for (int i = 0; i < numberOfStars; i++) {
            if (remainingTotalRating >= 1) {
                drawStar(internalCanvas, startingX, startingY, 1f, CustomRatingBar.Gravity.Left);
                remainingTotalRating -= 1;
            } else {
                drawStar(internalCanvas, startingX, startingY, remainingTotalRating, CustomRatingBar.Gravity.Left);
    ...
    private void drawFromRightToLeft(Canvas internalCanvas) {
        ...
        for (int i = 0; i < numberOfStars; i++) {
            if (remainingTotalRating >= 1) {
                drawStar(internalCanvas, startingX, startingY, 1f, CustomRatingBar.Gravity.Right);
                remainingTotalRating -= 1;
            } else {
                drawStar(internalCanvas, startingX, startingY, remainingTotalRating, CustomRatingBar.Gravity.Right);
                remainingTotalRating = 0;
            }
            startingX -= starsSeparation + currentStarSize;
        }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        CustomRatingBar.SavedState savedState = new CustomRatingBar.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        CustomRatingBar.SavedState savedState = (CustomRatingBar.SavedState) state;
    ...
    public CustomRatingBar.Gravity getGravity() {
        return gravity;
    }
    ...
    public class AnimationBuilder {
         ...
         * @return
         */
        public CustomRatingBar.AnimationBuilder setDuration(long duration) {
         ...
         * @return
         */
        public CustomRatingBar.AnimationBuilder setInterpolator(Interpolator interpolator) {
         ...
         * @return
         */
        public CustomRatingBar.AnimationBuilder setRatingTarget(float ratingTarget) {
         ...
         * @return
         */
        public CustomRatingBar.AnimationBuilder setRepeatCount(int repeatCount) {
         ...
         * @return
         */
        public CustomRatingBar.AnimationBuilder setRepeatMode(int repeatMode) {
