...
import com.officinetop.views.TimeWheelPicker
...
class WorkshopDetailActivity : BaseActivity(), OnGetFeedbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("WorkshopJson")) {
            ...
            Log.d("chekk_json_data",""+serviceAveragetime)
                ...
                body?.let {
                    ...
                    if (isStatusCodeValid(body)) {
                        ...
                        if (isRevision) {
                            ...
                            averageServiceTime = serviceAveragetime.toDouble() * 60

                            Log.d("check_data_time",""+serviceAveragetime+"   "+averageServiceTime)
                           ...
                           categoryID = json.optString("category_id", "")
                            averageServiceTime = json.optDouble("service_average_time", 0.0) * 60
                             ...
                             Log.d("check_json_for_main",""+json);
...
/*
    ...
    private fun checkAndBookService(packageDetail: JSONObject, bookingStartTime: String) {
        ...
        if (isAssembly) {
            ...
            val serviceSOSBookingCallEmergency = RetrofitClient.client.emergencySosServiceBooking(
                    getBearerToken() ?: "",
                    packageID.toString(), workshopUsersId.toString(), bookingStartTime, endTime, selectedDateFilter, sosUserLatitude, sosUserLongitude,
            ...
            val serviceMotBooking = RetrofitClient.client.serviceMotBooking(packageID.toString(), bookingStartTime, endTime, selectedDateFilter,
                    motServiceId.toString(), finalPrice.toString(), getOrderId(), getSavedSelectedVehicleID(), workshopCouponId, workshopUsersId.toString(), getServicesType(), motServiceSpecArray, specialConditionId, mainCategoryId, slotId, discountType,  getSelectedCar()?.carVersionModel?.idVehicle!!,getBearerToken()
                    ?: "")
    ...
    private fun getCalendarPrices() {
        ...
        Log.d("check_avrage_time", ""+servicesAverageTime)
